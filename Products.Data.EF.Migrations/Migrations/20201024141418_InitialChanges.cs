        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntityBaseId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddressBase", x => new { x.AddressTypeBaseId, x.OrganizationBaseId, x.EntityBaseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationBaseId1 = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerBase", x => x.OrganizationBaseId);
                    table.ForeignKey(
                        name: "FK_CustomerBase_OrganizationBase_OrganizationBaseId1",
                        column: x => x.OrganizationBaseId1,
                        principalTable: "OrganizationBase",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductBase", x => new { x.OrganizationBaseId, x.ProductSubCategoryBaseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductCategoryBaseId = table.Column<int>(nullable: false),
                    OrganizationBaseId = table.Column<int>(nullable: false),
                    RowVersion = table.Column<byte[]>(rowVersion: true, nullable: false),
                    Id = table.Column<int>(nullable: false),
                    DateUpdated = table.Column<DateTime>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCategoryLink", x => new { x.OrganizationBaseId, x.ProductCategoryBaseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesOrderProductBase", x => x.OrganizationBaseId);
                    table.ForeignKey(
                        name: "FK_SalesOrderProductBase_OrganizationBase_OrganizationBaseId1",
                        column: x => x.OrganizationBaseId1,
                        principalTable: "OrganizationBase",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBase", x => new { x.OrganizationBaseId, x.UserRoleBaseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesOrderBase", x => x.OrganizationBaseId);
                    table.ForeignKey(
                        name: "FK_SalesOrderBase_CustomerBase_CustomerBaseId",
                        column: x => x.CustomerBaseId,
                        principalTable: "CustomerBase",
                        principalColumn: "OrganizationBaseId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalesOrderBase_OrganizationBase_OrganizationBaseId1",
                        column: x => x.OrganizationBaseId1,
                        principalTable: "OrganizationBase",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerBase_OrganizationBaseId1",
                table: "CustomerBase",
                column: "OrganizationBaseId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrderBase_OrganizationBaseId1",
                table: "SalesOrderBase",
                column: "OrganizationBaseId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrderProductBase_OrganizationBaseId1",
