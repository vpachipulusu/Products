...
namespace Products.Service.Helpers
{
    public class JwtMiddleware
    {
        ...
        private readonly OAuth _appSettings;

        public JwtMiddleware(RequestDelegate next, IOptions<OAuth> appSettings)
        {
            _next = next;
        ...
        private void AttachUserToContext(HttpContext context, ICustomAuthenticationService authService, string token)
        {
            try
            {
